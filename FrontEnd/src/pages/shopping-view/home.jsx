...
//     title: "Free Shipping",
//     description:
//       "Our free shipping policy applies to all orders, regardless of the order value or destination.",
//   },
//   {
//     image:
...
//           (prevIndex) => (prevIndex + 1) % productList.length
//         );
...
//   // Ensure at least 4 products are displayed
//   const trendingProducts = productList.slice(
//     currentTrendingIndex,
//     currentTrendingIndex + 4
//   );
//   if (trendingProducts.length < 4) {
//     trendingProducts.push(...productList.slice(0, 4 - trendingProducts.length));
//   }
...
//               ? productList
//                   .slice(currentTrendingIndex, currentTrendingIndex + 4)
//                   .map((productItem) => (
//                     <div
//                       key={productItem.id}
...
function ShoppingHome() {
  ...
  function handleAddToCart(getCurrentProductId) {
    if (!user) {
      ...
      navigate("/auth/login"); // Or your login route
      toast({
